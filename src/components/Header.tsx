...
const Header = () => {
  return (
    <motion.header
      ...
      <div className="container mx-auto flex items-center justify-between px-4 md:px-8 py-[10px]">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 rounded-lg bg-whatsapp px-4 py-2.5 text-sm font-semibold text-whatsapp-foreground shadow-md hover:opacity-90 transition-opacity">
